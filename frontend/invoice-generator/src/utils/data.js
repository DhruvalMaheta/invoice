...
export const FEATURES = [
    {
        ...
        description : "Paste any text,email or receipt, let our AI instantly generate a complete,Professional invoice for you. "
    },
     {
        icon: BarChart2,
...
export const TESTIMONIALS = [
    {
     ...
     {
        quote : "I love the dashboard and reporting features. It helps me keep track of my finance effortlessly",
        author : "Peter Jones",
        title : "Consultant",
...
export const FAQS = [
    {
        ...
        answer : "Simply paste any text that contains invoice details-like an email, a list of items, or a work-summary- and our AI will instantly parse it to pre-fill a new invoice for you, saving your time and effort "
    },
     {
    ...
    },
     {
        ...
        answer : "Plans are per workspace, not per account. You can upgrade one workspace, and manage each workspace biling independently  "
    },
     {
